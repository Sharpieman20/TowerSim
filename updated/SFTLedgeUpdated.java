...
public class Run {
    ...
    public static final int MOB_CAP = 55;

    public static final int UPPER_MOB_CAP = 55;
            ...
            while (numTries < 4) {
                ...
                if (y != -1) {
                    ...
                    if (spider) {
                        ...
                        if (Math.sqrt(Math.pow((x-128),2)+Math.pow(z-128,2)) < 40.0) {
...
public static void main(String[] args) {
        ...
        for (int i = 0; i < num_tower_loops; i++) {
            ...
            if (cycles <= 9 && pearls >= NUM_PEARLS && time < MAX_TIME) {
